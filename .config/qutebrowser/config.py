...
## for a blank page.
## Type: FuzzyUrl
c.url.default_page = 'file:///home/lukasz/.config/qutebrowser/html/homepage.html'
...
c.url.searchengines = {'DEFAULT': 'http://www.google.com/search?q={}',
                        ...
                        'apkg':'https://www.archlinux.org/packages/?sort=&q={}&maintainer=&flagged='}
...
#	'all': [*c.hints.selectors['all'], 'input-output-copier'],
#}, pattern='*://*.codeforces.com/*')

config.set('hints.selectors', {
	'copy-button': ['div[class="input-output-copier"]'],
}, pattern='*://*.codeforces.com/*')
